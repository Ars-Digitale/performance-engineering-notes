...
- understanding the system model (→ [3.1 Foundations](#chap-03-01-foundations))
- measuring key metrics (→ [3.2 Core metrics and formulas](#chap-03-02-core-metrics-and-formulas))
...
### 3.3.2.1 Environment preparation and calibration {#3321-environment-preparation-and-calibration}
...
### 3.3.2.2 Use case definition and workload modeling {#3322-use-case-definition-and-workload-modeling}
...
### Non-functional requirements (NFRs) {#3322-non-functional-requirements}
...
### 3.3.2.3 Initial load / stress testing (problem discovery) {#3323-initial-load-stress-testing}
...
### 3.3.2.4 Analysis and bottleneck identification {#3324-analysis-and-bottleneck-identification}
...
### 3.3.2.5 Fixes and iterative validation {#3325-fixes-and-iterative-validation}
...
### 3.3.2.6 Intermediate validation (stable baseline) {#3326-intermediate-validation}
...
### 3.3.2.7 Long-duration validation (soak / endurance) {#3327-long-duration-validation}
...
### 3.3.2.8 Dimensioning and capacity definition {#3328-dimensioning-and-capacity-definition}
...
### 3.3.2.10 Verification and regression {#33210-verification-and-regression}
...
### 3.3.2.11 Benchmarking and reference points {#33211-benchmarking}
...
### 3.3.3.1 Black-box approach {#3331-black-box}
...
### 3.3.3.2 White-box approach {#3332-white-box}
...
### 3.3.3.3 Observability and tooling {#3333-observability-and-tooling}
...
### 3.3.3.4 Combining both approaches {#3334-combining-both}
...
### 3.3.4.1 Load testing {#3341-load-testing}
...
### 3.3.4.2 Diagnostics {#3342-diagnostics}
...
### 3.3.4.3 Relationship between load testing and diagnostics {#3343-relationship-between-load-testing-and-diagnostics}
