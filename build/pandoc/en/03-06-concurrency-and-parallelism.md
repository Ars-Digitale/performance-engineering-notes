...
- the number of in-flight requests (→ [3.2.1 Little’s Law](#chap-03-02-core-metrics-and-formulas))

This leads to:

- resource sharing
- potential queueing (→ [3.5.2 Saturation and queueing](#chap-03-05-system-behavior-under-load))
...
- queueing (→ [3.5.2 Saturation and queueing](#chap-03-05-system-behavior-under-load))
- latency under load
...
- saturation (→ [3.5.2 Saturation and queueing](#chap-03-05-system-behavior-under-load))
- non-linear degradation (→ [3.5.3 Non-linear degradation](#chap-03-05-system-behavior-under-load))
