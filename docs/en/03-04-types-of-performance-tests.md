...
<a id="341-purpose-of-performance-testing"></a>
...
- queueing and saturation effects (→ [3.5 System behavior under load](./03-05-system-behavior-under-load.md))
- concurrency limits (→ [3.6 Concurrency and parallelism](./03-06-concurrency-and-parallelism.md))
- runtime and memory effects (→ [3.7 Runtime and memory model](./03-07-runtime-and-memory-model.md))
- resource saturation (→ [3.8 Resource-level performance](./03-08-resource-level-performance.md))
